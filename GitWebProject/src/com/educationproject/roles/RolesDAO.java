...
import com.educationproject.users.BaseHibernateDAO;
 ...
 * 
 * @see com.educationproject.roles.Roles
	...
	public Roles findById(java.lang.Integer id) {
		...
		try {
			Roles instance = (Roles) getSession().get(
					"com.educationproject.roles.Roles", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Roles instance) {
		...
		try {
			List results = getSession()
					.createCriteria("com.educationproject.roles.Roles")
